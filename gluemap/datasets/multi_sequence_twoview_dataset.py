...
class MultiSequencePairs(DemoBaseDataset):
    def __init__(self, args, datasets):
        ...
        for dataset in self.datasets:
            img_list.extend(get_image_list(os.path.join(args.images_path, dataset)))
        ...
        self.images_path = [self.images_path_root for _ in range(len(self.images_list))]
    ...
    def _construct_pairs(self, args, img_list):
        ...
        for dataset in datasets:
            ...
            neighbors, descriptors_db = self._retrieve_descriptors_and_neighbors(
            ...
            for k in range(neighbors.shape[0]):
                ...
                for m in range(1, neighbors.shape[1]):
                    ...
                    self.sequential_edges.append((min(center, nbr), max(center, nbr)))
