...
def get_parameter_groups(model, weight_decay, layer_decay=1.0, skip_list=(), no_lr_scale_list=[]):
    ...
    for name, param in model.named_parameters():
        ...
        if name.find("track_head") >= 0:
            group_name = group_name + "_track_head"
        elif name.find("rotation_head") >= 0:
            group_name = group_name + "_rotation_head"
        ...
        if group_name not in parameter_group_names:
            ...
            elif group_name.find("track_head") >= 0:
                scale = 1
            elif group_name.find("rotation_head") >= 0:
                scale = 1.
            else:
                scale = 1.
